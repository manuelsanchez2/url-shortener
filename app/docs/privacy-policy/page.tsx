export default function PrivacyPolicyPage() {
  return (
    <div className="max-w-xl mx-auto bg-white p-8 rounded shadow-lg mt-8">
      <h1 className="text-2xl font-bold mb-4">mswebLink Privacy Policy</h1>
      <p className="text-gray-800 mb-4">
        mswebLink is committed to protecting the privacy of its users. This
        privacy policy describes how mswebLink collects, uses, and protects the
        personal information it receives from its users.
      </p>

      <h2 className="text-xl font-bold mb-2">Information Collected</h2>
      <p className="text-gray-800 mb-4">
        mswebLink collects the following personal information from its users:
      </p>
      <ul className="list-disc list-inside text-gray-800 mb-4">
        <li>Name</li>
        <li>Email Address</li>
        <li>
          Profile Picture (in case of authentication through Google or GitHub)
        </li>
      </ul>
      ...
      <ul className="list-disc list-inside text-gray-800 mb-4">
        ...
        <li>Improve and optimize the services offered by mswebLink.</li>
      </ul>

      <p className="text-gray-800 mb-4">
        For questions or concerns about this privacy policy, users can contact
        mswebLink at manusansan22@gmail.com.
      </p>
